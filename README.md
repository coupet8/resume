...
## :briefcase: Проекты
#### Проект №1. Анализ обращений на портале <a href="/resume/portfolio/Проект №1. Анализ обращений на портале.xlsx>
#### Проект №2. Анализ работы и калькулятор юнит-экономики онлайн-кинотеатра <a href="/resume/portfolio/Проект №2. Анализ работы и калькулятор юнит-экономики онлайн-кинотеатра.xlsx>
#### Проект №3. Гипотезы причин и исправления <a href="/resume/portfolio/Проект №3. Гипотезы причин и исправления.pptx>
#### Проект №4. Метрики и воронка конверсий агрегатора такси <a href="/resume/portfolio/Проект №4. Метрики и воронка конверсий агрегатора такси.xlsx>
#### Проект №5. Тестовое задание Excel, SQL <a href="/resume/portfolio/Проект №7. Тестовое задание Excel, SQL.xlsx>
## :wave: Контакты
